...
class FormPage (BasePage):
    ...
    def fill_fields_and_submit(self):
       ...
       path = generated_file()
       #first_name = 'FirstName' Вместо этих трёх строк используется person
       # #last_name = 'LastName'
       # email = 'mail@python.com'
       self.remove_footer()
       ...
       os.remove(path) #удалить файлы которые нагенерились
    ...
    def form_result(self):
        ...
        #result_text=[] так или так, строкой выше красивый.
